...
module.exports.loop = function () {
    ...
    /*if (Game.rooms["W2N31"].find(FIND_HOSTILE_CREEPS)){
        ...
        Game.spawns['Spawn0'].spawnCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], newName, {memory: {role: "harvest", perma_role: "none"}});
        ...
        console.log('Spawning: ' + newName);
        Game.spawns['Spawn0'].spawnCreep([WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], newName, {memory: {role: "upgrader", perma_role: "upgrader", carrying : 0}});
    }
}
